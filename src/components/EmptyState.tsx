...
export default function EmptyState({
  ...
  return (
    <div className="border-line bg-surface animate-rise flex flex-col items-center gap-3 rounded-2xl border border-dashed px-6 py-12 text-center">
      {icon && (
        <span className="bg-surface-muted text-ink-400 animate-pop flex h-12 w-12 items-center justify-center rounded-full">
          {icon}
        </span>
      )}
      <h3 className="text-ink-900 text-lg font-semibold">{title}</h3>
